...
//   const { event, eventAttendees } = route.params;
          ...
          <View style={styles.iconContainer}>
            <View style={styles.iconWrapper}>
              ...
              <View style={styles.attendingFriendsContainer}>
                {eventAttendees.attendingFriends && eventAttendees.attendingFriends.map((imageUrl, idx) => (
                  <Image
                    key={idx}
                    source={{ uri: imageUrl }}
              ...
              <View style={styles.interestedFriendsContainer}>
                {eventAttendees.interestedFriends && eventAttendees.interestedFriends.map((imageUrl, idx) => (
                  <Image
                    key={idx}
                    source={{ uri: imageUrl }}
                    style={styles.friendProfileImage}
